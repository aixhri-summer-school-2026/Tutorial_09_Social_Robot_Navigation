...
if [ "$color_prompt" = yes ]; then
    PS1="${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\W\[\033[0;33m\]\$(git_branch)\[\033[00m\]\$ "
else
    PS1="${debian_chroot:+($debian_chroot)}\[\033[0;35m\]\u@\h\[\033[00m\]:\W\[\033[00;33m\]\$(git_branch)\[\033[00m\]\$ "
fi
unset color_prompt force_color_prompt

## Removes colors and uses simple terminal
